        ...
        <!-- <nav id="navigation" class="navigation navigation-landscape">
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                <ul class="nav-menu">
                    ...
                    <li class="{{ request()->route()->getName() == 'school' ? 'active' : null}}"><a href="{{ route('school') }}">School<span class="submenu-indicator"></span></a></li>
                ...
                <ul class="nav-menu nav-menu-social align-to-right">
                    ...
                    <li class="login_click search">
                        {!! Form::model(request()->all(), ['route' => 'school', 'method' => 'get', 'class' => 'form-inline addons']) !!}
            ...
            <div class="collapse navbar-collapse" id="navbar-header">
                <ul class="navbar-nav mr-auto">
                    @foreach($menus as $menu)
                        <li class="nav-item {{ request()->route()->getName() == $menu->route ? 'active' : null}}"><a class="nav-link" href="{{ route($menu->route) }}">{{ $menu->title }}<span class="submenu-indicator"></span></a>
                        </li>
                    @endforeach
                </ul>
