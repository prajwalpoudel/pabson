        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="banner-search-2 transparent">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('auth.register') }}" class="btn btn-modern dark">Register<span><i class="ti-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
                ...
                <div class="education_block_grid style_2">
                    ...
                    <div class="education_block_thumb n-shadow">
                        <a href="{{ route('coming.soon') }}">
                            <img src="{{ asset('front/') }}/assets/img/supervision.jpg" class="img-fluid" alt="">
                        </a>
                    </div>
